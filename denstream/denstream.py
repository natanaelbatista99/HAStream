...
class DenStream(base.Clusterer, nn.Module):
    ...
    **Offline generation of clusters on-demand (clustering)**
    ...
    def _initial_dbscan(self):
        ...
        self.df_runtime_final.at[self.timestamp, 'summarization'] = end_summarization - start_summarization
    ...
    def build(self, objects, mptsi):
        print("Mpts: ", mptsi, " - MCs: ", len(self.p_micro_clusters))
    ...
    def predict_one(self, objects, w=None):
        ...
        print("Computing Multiple Clusterings: t_", self.timestamp)
